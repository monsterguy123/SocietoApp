      ...
      <section className="bg-white">
        <div className="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
          <div className="mr-auto place-self-center lg:col-span-7">
            <Image alt="#" height={70} width={70} src={"https://appsnstuff.com/img/portfolio_images/devices/socity-management/socity-management-logo.png"}/>
          ...
          <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
            <Image height={500} width={500} alt="#" src="https://houstonagentmagazine.com/wp-content/uploads/sites/7/2021/02/Race_Homeownership_Illustration-scaled.jpg"  />
          </div>
        </div>
      </section>
      <br />
